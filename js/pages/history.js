(function () {
  ...
  window.editPastSession = function (id) {
    ...
    appState.ui.sessionForm = {
      ...
      date: session.date || defaultForm.date,
      sessionType: session.sessionType || "quran",
      quran: session.quran ? JSON.parse(JSON.stringify(session.quran)) : defaultForm.quran,
      islamic: session.islamic ? JSON.parse(JSON.stringify(session.islamic)) : defaultForm.islamic,
      group: session.groupForm ? JSON.parse(JSON.stringify(session.groupForm)) : defaultForm.group,
    };
  ...
  function renderStudentTimeline(student) {
    ...
    return `<div style="display:flex;flex-direction:column;gap:var(--sp-3);">${sessions
      .map((s) => {
        ...
        return `
        <div class="card-soft hover-elevation" style="position:relative;overflow:hidden;">
          ...
          <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex gap-2" style="flex-wrap:wrap;">
              ...
              ${groupLabel ? `<span class="badge-soft"><i class='ph-duotone ph-users' style='margin-left:4px;'></i>${groupLabel}</span>` : ""}
            </div>
        ...
        <div>
          <div class="d-flex align-items-center gap-3 mb-5">
            ...
            <div>
              ...
              <div style="font-size:var(--fs-xs);color:var(--text-muted);">تتبع سجل الحصص والتقييمات</div>
            </div>
          </div>
          ${renderStudentList()}
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-5">
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <div style="font-size:var(--fs-xs);color:var(--text-muted);">جميع الحصص والتفاصيل</div>
            </div>
          </div>
